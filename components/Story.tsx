    ...
    <section id="story" className="py-12 px-4 text-center bg-transparent relative overflow-hidden">
      ...
      >
        <div className="glass-maroon p-10 md:p-16 rounded-[2rem] border-2 border-[#B76E79]/10 shadow-2xl relative overflow-hidden">
          ...
          {/* Text Matter Next */}
          <TypewriterText text={"ವಿಧಿಯು ಎರಡು ಹೃದಯಗಳನ್ನು ಒಂದಾಗಿಸಲು ನಿರ್ಧರಿಸಿದಾಗ, ಜೀವನವು ಅವುಗಳನ್ನು ನಿಧಾನವಾಗಿ ಹತ್ತಿರಕ್ಕೆ ತರುತ್ತದೆ.\nಸರಳವಾದ ಮೊದಲ ಭೇಟಿಯಿಂದ ಪವಿತ್ರ ವೈವಾಹಿಕ ವಾಗ್ದಾನಗಳವರೆಗೆ, ಈ ಪ್ರಯಾಣವು ಪ್ರೀತಿ ಮತ್ತು ಆಶೀರ್ವಾದಗಳಿಂದ ಅರಳಿ ಬೆಳಗಿದೆ. 💞✨💍"} />
